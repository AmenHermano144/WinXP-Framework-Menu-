...
namespace ksd
{
    ...
    void BeginToolbar()
    {
        ...
        dl->AddLine(ImVec2(ksd::BodyLeft(), y), ImVec2(ksd::BodyRight(), y), style::InputBorder, 1.f);
    }
    ...
    bool ToolButton(const char* id, int glyph, const char* tooltip, bool enabled)
    {
        ...
        else if (hovered)
        {
            dl->AddRectFilledMultiColor(a, b,
                IM_COL32(255, 236, 200, 255), IM_COL32(255, 236, 200, 255),
                IM_COL32(255, 210, 140, 255), IM_COL32(255, 210, 140, 255));
            dl->AddRect(a, b, IM_COL32(200, 130, 20, 255), 0.f, 0, 1.f);
        }
    ...
    void ToolSeparator()
    {
        ...
        dl->AddLine(ImVec2(x, s_tbY + 1.f), ImVec2(x, s_tbY + sz - 1.f), style::InputBorder, 1.f);
        s_tbX += 8.f;
    }
}
