...
namespace ksd
{
    static bool DrawCheckbox(const char* label, bool* v)
    {
        ...
        dl->AddRectFilledMultiColor(boxMin, boxMax,
            IM_COL32(255, 255, 255, 255), IM_COL32(255, 255, 255, 255),
            IM_COL32(230, 236, 246, 255), IM_COL32(230, 236, 246, 255));
        ...
        if (*v)
        {
            ...
            const ImU32 tick = IM_COL32(21, 66, 138, 255);
            dl->AddLine(ImVec2(x + 3.f, y + 6.f), ImVec2(x + 5.f, y + 9.f), tick, 2.0f);
            dl->AddLine(ImVec2(x + 5.f, y + 9.f), ImVec2(x + 10.f, y + 3.f), tick, 2.0f);
        }
