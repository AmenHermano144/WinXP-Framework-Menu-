...
namespace ksd
{
    void Separator()
    {
        ...
        dl->AddLine(ImVec2(pos.x, y), ImVec2(pos.x + w, y), style::GroupBorder, 1.f);
        ksd::AddItem(ImVec2(w, 6.f));
    }
    ...
    void SeparatorText(const char* label)
    {
        ...
        dl->AddLine(ImVec2(lineX, y), ImVec2(pos.x + w, y), style::GroupBorder, 1.f);
