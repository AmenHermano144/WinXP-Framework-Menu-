...
void gui::Render() noexcept
{
    ...
    ksd::BeginMain("Zap Win XP Menu inspired in Kingsleys win95 menu");
    ...
    if (ksd::BeginMenuBar())
    {
        ...
        if (ksd::BeginMenu("&Help"))
        {
            if (ksd::MenuItem("&About..."))
            {
                ...
                ksd::OpenMessageBox("about", "About", "Made by Zapcrash", aboutLinks, 1);
            }
            ksd::EndMenu();
        }
        ksd::EndMenuBar();
    ...
    ksd::TabButton("Toggles", 0);
    ksd::TabButton("Style", 1);
    ksd::TabButton("Values", 2);
    ksd::TabButton("Lists", 3);
    ksd::TabButton("Selection", 4);
    ksd::TabButton("Actions", 5);
    ksd::TabButton("Settings", 6);
