...
int APIENTRY wWinMain(HINSTANCE, HINSTANCE, LPWSTR, int)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, ::GetModuleHandleW(nullptr), nullptr, ::LoadCursorW(nullptr, IDC_ARROW), nullptr, nullptr, L"zapwinxpFramework", nullptr };
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowExW(0, wc.lpszClassName, L"Zap Win XP Menu inspired in Kingsleys win95 menu", dwStyle, iPosX, iPosY, iWinW, iWinH, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (!bDone)
    {
        ...
        ImGui::Render();
        float clearRgba[4] = { 0.227f, 0.427f, 0.647f, 1.f };
        if (g_embedded)
        {
            clearRgba[0] = 0.227f;
            clearRgba[1] = 0.427f;
